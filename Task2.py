...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - total preparation time (in minutes) needed to prepare the lasagna.
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    This function takes two arguments:
      - the number of layers you added to the lasagna
      - the number of minutes the lasagna has been baking in the oven,
    and returns how many minutes in total you've worked on cooking the lasagna.
    """
